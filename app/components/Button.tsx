...
export interface ButtonProps extends PressableProps {
  ...
  /**
   * An optional style override for the "disable" state.
   */
  disabledStyle?: StyleProp<ViewStyle>
  /**
   * An optional style override for the button text when in the "disable" state.
   */
...
export function Button(props: ButtonProps) {
  ...
  function $textStyle({ pressed }) {
    return [
      ...
      !!disabled && [$disabledTextPresets[preset], $disabledTextStyleOverride],
    ]
  }
...
const $viewPresets = {
  ...
  default: [$baseViewStyle, { backgroundColor: colors.palette.primary300 }] as StyleProp<ViewStyle>,
...
const $textPresets: Record<Presets, StyleProp<TextStyle>> = {
  default: [$baseTextStyle, { color: colors.palette.neutral500 }],
  outline: [$baseTextStyle, { color: colors.palette.neutral100 }],
  reversed: [$baseTextStyle, { color: colors.palette.neutral100 }],
}
const $disabledTextPresets: Record<Presets, StyleProp<TextStyle>> = {
  default: [$baseTextStyle, { color: colors.palette.neutral300 }],
  outline: [$baseTextStyle, { color: colors.palette.neutral300 }],
  reversed: [$baseTextStyle, { color: colors.palette.neutral100 }],
}

const $pressedViewPresets: Record<Presets, StyleProp<ViewStyle>> = {
  default: { backgroundColor: colors.palette.primary500 },
  outline: { backgroundColor: colors.palette["neutral100_12%"] },
  reversed: { backgroundColor: colors.palette.neutral700 },
}

const $disabledViewPresets: Record<Presets, StyleProp<ViewStyle>> = {
  default: { backgroundColor: colors.palette["neutral300_30%"] },
  outline: { backgroundColor: colors.palette["neutral300_30%"] },
  reversed: { backgroundColor: colors.palette.neutral700 },
}
